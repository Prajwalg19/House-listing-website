...
function Listing() {
    ...
    return (
        <div>
            ...
            <div className="cursor-pointer fixed md:top-[13%] top-[24%] right-[3%] md:right-[3%]  z-[1]">
                <HiShare
                ...
                />
                {copied && <p className="fixed md:top-[16%] md:right-[6%] top-[27%] right-[10%] whitespace-nowrap text-black bg-white rounded-md p-1">Link Copied</p>}
            </div>
            ...
            <div className="relative flex flex-col items-center justify-center max-w-6xl p-3 m-5 shadow-md md:flex-row bg-slate-50 space-y-3 md:space-y-0 md:mx-auto md:space-x-6 ">
                <div className="h-[400px] md:w-1/2 w-full relative top-2">
                    ...
                    <p className="flex space-x-3 justify-start truncate  mt-3  items-center">
                        <MdLocationOn className="text-xl text-green-400" />
                        <span className="font-semibold">{listing.address}</span>
                    </p>
                    <div className="flex font-semibold space-x-4 justify-start w-[75%] mt-3 ">
                        <p className="w-[40%] bg-red-700 text-white text-center p-2 rounded-md">
                            For <span>{listing.sellOrRent}</span>
                        </p>
                        {listing.discountedPrice && (
                            <p className="w-[40%] bg-green-600 p-2 rounded-md text-white text-center whitespace-nowrap">
                    ...
                    <p className="flex space-x-5 mt-2 items-center text-sm font-semibold">
                        {listing.bedrooms && (
                        ...
                        {listing.parking && (
                            <p className="flex space-x-1 items-center whitespace-nowrap">
                                <FaParking className="text-base" /> <span>Parking Spot</span>
                            </p>
                        )}
                        <p className="flex space-x-1 items-center whitespace-nowrap">
                ...
                <div className="bg-pink-300 h-[400px] md:w-1/2 w-full"></div>
            </div>
        </div>
    );
}
