        ...
        <>
            {listing.length > 0 && (
                <div className="max-w-7xl mx-auto ">
                    <ul className="flex flex-col justify-center sm:justify-start sm:flex-row space-around flex-wrap">
                        {listing.map((l) => {
                            let list = l.data;
                            return (
                                <li key={l.id} className=" mb-8 z-0 w-full relative bg-white sm:w-[300px] shadow-md hover:shadow-xl rounded-md overflow-hidden transition-shadow duration-150 m-[10px]">
