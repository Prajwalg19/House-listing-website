        ...
        <>
            {listing.length > 0 && (
                <div className="max-w-7xl mx-auto ">
                    <ul className="flex flex-col sm:flex-row space-between flex-wrap">
                        {listing.map((l) => {
                            let list = l.data;
                            return (
                                <li key={l.id} className=" mb-8 z-0 relative bg-white w-[300px] shadow-md hover:shadow-xl rounded-md overflow-hidden transition-shadow duration-150 m-[10px]">
